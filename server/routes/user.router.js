...
router.post("/register", (req, res, next) => {
  ...
  const queryText = `INSERT INTO "user" (name, username, password, trainer, personal, nutrition, mind, health, pronouns)
    VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING id`;
  pool
    .query(queryText, [name, username, password, trainer, personal, nutrition, mind, health, pronouns])
    .then((result) => {
